...
const Home: NextPage = () => {
  ...
  return (
    <>
      ...
      <div className="flex min-h-screen w-full flex-col items-center gap-8 px-2 pt-8 sm:py-20 sm:px-8">
        <div className="flex w-full items-center md:max-w-2xl">
          <h1 className="text-2xl font-bold sm:text-3xl">
            Github Task Manager
          </h1>
          <button className="btn-primary btn ml-auto" onClick={() => signOut()}>
            sign out
          </button>
        </div>
        <input
          type="text"
          className="input-bordered input w-full md:max-w-2xl"
          value={query.text}
          placeholder="Search issues by title or body"
          onChange={handleQueryChange}
        />
        <div className="flex w-full flex-wrap md:max-w-2xl">
          ...
          <div className="dropdown">
            <label tabIndex={1} className="btn-primary btn m-1">
        ...
        <ul className="flex w-full flex-col gap-4 md:max-w-2xl">
          {isError && (
